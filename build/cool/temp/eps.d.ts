declare namespace Eps {
	...
	interface BaseComm {
		 ...
		 * 文件上传
		 */
		uploadOscCsv(data?: any): Promise<any>;
		/**
		 * 文件上传模式
		 */
	...
	interface SignalAttachment {
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<AttachmentEntity>;
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
		 ...
		 * 列表查询
		 */
		list(data?: any): Promise<AttachmentEntity[]>;
		/**
		 * 新增
		 */
		add(data?: any): Promise<any>;
	...
	interface SignalFeature {
		 ...
		 * 图像对比
		 */
		imageComparison(data?: any): Promise<any>;
		/**
		 * 导入示波器数据
		 */
		importOscCsv(data?: any): Promise<any>;
		/**
		 * 删除
		 */
		delete(data?: any): Promise<any>;
		 ...
		 * 单个信息
		 */
		info(data?: any): Promise<FeatureEntity>;
		/**
		 * 分页查询
		 */
		page(data?: any): Promise<{
		 ...
		 * 列表查询
		 */
		list(data?: any): Promise<FeatureEntity[]>;
		/**
		 * 新增
		 */
		add(data?: any): Promise<any>;
	...
	type Service = {
		...
		signal: { attachment: SignalAttachment; feature: SignalFeature };
